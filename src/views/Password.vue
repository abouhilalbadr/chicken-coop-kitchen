...
<template>
	<div class="flex flex-col justify-center items-center min-h-screen gap-6 p-8">
		<div class="flex justify-center items-center">
			<div class="flex flex-col items-center gap-2 border-2 border-main rounded-md w-64 py-4 bg-main">
				<Kitchen class="h-32 fill-white" />
				<span class="text-white font-bree-serif font-bold text-3xl">Cuisine</span>
			</div>
		</div>
